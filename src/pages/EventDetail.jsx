...
import { Calendar, MapPin, Clock, Users, ArrowLeft, Ticket, Loader2, Edit } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 mt-20">
      ...
      <div className="relative h-96 bg-gradient-to-br from-primary to-accent-purple">
        ...
        {/* Edit Button - Se o usuário é o criador */}
        {authService.isAuthenticated() && authService.getCurrentUser()?.id === evento.user_id && (
          <button
            onClick={() => navigate(`/editar-evento/${id}`)}
            className="absolute top-6 right-6 flex items-center space-x-2 px-4 py-3 bg-white/10 backdrop-blur-md rounded-lg text-white hover:bg-white/20 transition"
          >
            <Edit size={20} />
